...
Generate the plot using the *generateaWhereStdDevChart* function from the *aWhereCharts* package. Display the plot and write it to .JPEG file using the WriteJpeg function, an external R function in the "supporting_functions.R" file. 
